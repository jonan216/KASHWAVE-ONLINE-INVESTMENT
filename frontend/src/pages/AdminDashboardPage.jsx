    ...
    <div className="space-y-8 pb-8">
      ...
      <div className="bg-white rounded-3xl border border-[#102542]/8 shadow-soft p-2 overflow-x-auto flex items-center gap-1">
        {[
          ...
          { id: 'roi-approvals', label: 'Daily Profit Approvals', icon: FiCheckSquare, badge: profitLedger.filter(p => p.payout_status === 'pending_approval').length },
      ...
      {/* ── 1. DASHBOARD ANALYTICS & DAILY PROFIT APPROVALS TAB ─────────────────── */}
      {activeTab === 'dashboard' && (
        <div className="space-y-6">
          {/* Stat Widgets Grid */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            <div className="bg-white rounded-3xl p-5 border border-[#102542]/8 shadow-soft">
              <div className="flex items-center justify-between mb-2">
                <div className="w-9 h-9 rounded-2xl bg-[#102542]/10 text-[#102542] flex items-center justify-center">
                  <FiUsers className="w-4 h-4" />
                </div>
                <span className="text-[9px] font-extrabold text-[#16A34A] bg-[#16A34A]/10 px-2 py-0.5 rounded-full">Active</span>
              </div>
              <p className="text-[9px] font-extrabold text-[#102542]/50 uppercase tracking-widest">Registered Investors</p>
              <p className="text-xl font-extrabold text-[#102542] mt-1">{stats?.totalUsers || users.length}</p>
            </div>

            <div className="bg-white rounded-3xl p-5 border border-[#102542]/8 shadow-soft">
              <div className="flex items-center justify-between mb-2">
                <div className="w-9 h-9 rounded-2xl bg-[#16A34A]/10 text-[#16A34A] flex items-center justify-center">
                  <FiDollarSign className="w-4 h-4" />
                </div>
                <span className="text-[9px] font-extrabold text-[#16A34A] bg-[#16A34A]/10 px-2 py-0.5 rounded-full">Processed</span>
              </div>
              <p className="text-[9px] font-extrabold text-[#102542]/50 uppercase tracking-widest">Total Deposit Volume</p>
              <p className="text-xl font-extrabold text-[#16A34A] mt-1">
            ...
            <div className="bg-white rounded-3xl p-5 border border-[#102542]/8 shadow-soft">
              <div className="flex items-center justify-between mb-2">
                <div className="w-9 h-9 rounded-2xl bg-[#D4AF37]/10 text-[#D4AF37] flex items-center justify-center">
                  <FiCheckSquare className="w-4 h-4" />
                </div>
                <span className="text-[9px] font-extrabold text-[#D4AF37] bg-[#D4AF37]/10 px-2 py-0.5 rounded-full">Daily ROI</span>
              </div>
              <p className="text-[9px] font-extrabold text-[#102542]/50 uppercase tracking-widest">Pending Profit Approvals</p>
              <p className="text-xl font-extrabold text-[#D4AF37] mt-1">
                {profitLedger.filter(p => p.payout_status === 'pending_approval').length} Pending
              </p>
            </div>

            <div className="bg-white rounded-3xl p-5 border border-[#102542]/8 shadow-soft">
              <div className="flex items-center justify-between mb-2">
                <div className="w-9 h-9 rounded-2xl bg-[#F59E0B]/10 text-[#F59E0B] flex items-center justify-center">
                  <FiCheckSquare className="w-4 h-4" />
                </div>
                <span className="text-[9px] font-extrabold text-[#F59E0B] bg-[#F59E0B]/10 px-2 py-0.5 rounded-full">Action Req.</span>
              </div>
              <p className="text-[9px] font-extrabold text-[#102542]/50 uppercase tracking-widest">Pending Deposits</p>
              <p className="text-xl font-extrabold text-[#F59E0B] mt-1">{pendingDeposits.length}</p>
            </div>

            <div className="bg-white rounded-3xl p-5 border border-[#102542]/8 shadow-soft">
              <div className="flex items-center justify-between mb-2">
                <div className="w-9 h-9 rounded-2xl bg-[#DC2626]/10 text-[#DC2626] flex items-center justify-center">
                  <FiAlertCircle className="w-4 h-4" />
                </div>
                <span className="text-[9px] font-extrabold text-[#DC2626] bg-[#DC2626]/10 px-2 py-0.5 rounded-full">Friday Gate</span>
              </div>
              <p className="text-[9px] font-extrabold text-[#102542]/50 uppercase tracking-widest">Pending Withdrawals</p>
              <p className="text-xl font-extrabold text-[#DC2626] mt-1">{pendingWithdrawals.length}</p>
            </div>
          </div>
          ...
          {/* ── EMBEDDED INVESTOR PROFIT APPROVAL LEDGER ON MAIN DASHBOARD PAGE ── */}
          <div className="bg-white rounded-4xl border border-[#102542]/8 shadow-soft overflow-hidden space-y-4">
            <div className="p-6 border-b border-[#102542]/8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                <div className="flex items-center gap-2">
                  <span className="px-2.5 py-0.5 bg-[#D4AF37] text-[#102542] text-[9px] font-black rounded-full uppercase">
                    Daily Approval Required
                  </span>
                  <h3 className="text-base font-extrabold text-[#102542]">Investor Profit Tracking & Daily Approval Ledger</h3>
                </div>
                <p className="text-xs text-[#102542]/60 font-medium mt-0.5">
                  Review active investor contracts, start timestamps, accrued profits earned, and approve daily payouts to users Available Balances.
                </p>
              </div>
